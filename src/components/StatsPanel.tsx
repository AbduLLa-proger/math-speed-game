...
export const StatsPanel = () => {
  return (
    <aside className="overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-sm flex flex-col justify-between h-full">
      <div className="p-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="text-[22px] font-black leading-none text-slate-950">
              Статистика
            </h2>
        ...
        <div className="mt-6 flex items-center gap-5 rounded-[18px] border border-amber-300 bg-amber-50/60 p-5">
          ...
          <div>
            ...
            <p className="mt-2 text-[30px] font-black leading-none text-slate-950">
              9 / 10
            </p>
      ...
      <div className="border-t border-slate-200 p-6">
        ...
        <button
          type="button"
          className="mt-5 h-[52px] w-full rounded-[14px] border border-blue-300 bg-white text-[15px] font-extrabold text-blue-600 transition hover:bg-blue-50"
        >
